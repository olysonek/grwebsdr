...
public:
	...
	static sptr make(int in_rate, int out_rate, int cutoff, int out_cutoff, int out_trans);
	~fm_demod();
private:
	fm_demod(int in_rate, int out_rate, int cutoff, int out_cutoff, int out_trans);
